...
export function TemplateOutlookSignaturePromashtestRegiony({ inputName, inputFamily, inputPatronymic, inputPosition, inputTelephone, inputTelephoneExt, inputTelephoneSecond, inputAddress, avatarUrl }: ISignatureProps) {
  return (
    <>
      <Html lang="ru">
        <HeadCustom />
