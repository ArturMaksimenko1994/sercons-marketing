...
export function TemplateOutlookSignaturePromashtestRegionySmall({ inputName, inputFamily, inputPatronymic, inputPosition, inputTelephone, inputTelephoneExt, inputTelephoneSecond, inputAddress, avatarUrl }: ISignatureProps) {
  return (
    <>
      <Html lang="ru">
        <HeadCustom />
                  ...
                  <Row align='right'>
                    <Column align='right'>
                      <Link href="https://prommash-test.ru/">
                        <Img src="https://api.marketing.serconsrus.ru/wp-content/uploads/2024/08/ПМТ-Регионы.png" alt="telephone" width="180" height="18" />
                      </Link>
                    </Column>
                  </Row>
                  <Row style={{ paddingTop: "70px" }}>
                    <Column align='right' >
                      <Img src="https://api.marketing.serconsrus.ru/wp-content/uploads/2024/08/link-icon-regiony.png" alt="telephone" width="20" height="24" />
                    </Column>
                  </Row>
                  <Row>
                    <Column align='right'>
