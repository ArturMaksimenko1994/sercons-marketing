...
export function TemplateOutlookSignatureSerconsSmall({ inputName, inputFamily, inputPatronymic, inputPosition, inputTelephone, inputTelephoneExt, inputTelephoneSecond, inputAddress }: ISignatureProps) {
  return (
    <>
      <Html lang="ru">
        <HeadCustom />
