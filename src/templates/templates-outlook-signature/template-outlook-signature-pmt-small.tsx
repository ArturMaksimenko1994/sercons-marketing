...
export function TemplateOutlookSignaturePmtSmall({ inputName, inputFamily, inputPatronymic, inputPosition, inputTelephone, inputTelephoneExt, inputTelephoneSecond, inputAddress, avatarUrl }: ISignatureProps) {
  return (
    <>
      <Html lang="ru">
        <HeadCustom />
          ...
          <Row align='left' width="660" style={{ width: "660px", maxWidth: "660px", backgroundColor: "#F1F1F1", color: "#000000", margin: "0" }}>
            <Column align='left' style={{ paddingTop: "12px", paddingBottom: "12px", }}>
              <Row>
                        ...
                        {inputPosition && (
                          <Row>
                            <Column align='left' valign='middle' style={{ width: "100%" }}>
                              <table role="presentation" style={{ backgroundColor: "#0F173E", fontSize: "14px", color: "#FFF", fontFamily: "'Arial', sans-serif" }}>
                                <tr>
                ...
                <Column style={{ width: '180px' }}  valign="top">
                  <Row align='right'>
                    <Column align='right'>
                      <Link href="https://serconsmed.com/">
                        <Img src="https://api.marketing.serconsrus.ru/wp-content/uploads/2024/08/logo-ptm.png" alt="telephone" width="85" height="46" />
                      </Link>
                    </Column>
                  </Row>
