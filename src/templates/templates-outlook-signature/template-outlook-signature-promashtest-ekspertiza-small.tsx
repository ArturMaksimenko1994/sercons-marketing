...
export function TemplateOutlookSignaturePromashtestEkspertizaSmall({ inputName, inputFamily, inputPatronymic, inputPosition, inputTelephone, inputTelephoneExt, inputTelephoneSecond, inputAddress, avatarUrl }: ISignatureProps) {
  return (
    <>
      <Html lang="ru">
        <HeadCustom />
        <Section>
          <Row align='left' width="660" style={{ width: "660px", maxWidth: "660px", backgroundColor: "#F1F1F1", color: "#000000", margin: "0" }}>
            <Column align='left' style={{ paddingTop: "12px", paddingBottom: "12px", }}>
              <Row>
                <Column width="10" style={{ backgroundColor: "#AA974B" }}></Column>
                        ...
                        {inputPosition && (
                          <Row>
                            <Column align='left' valign='middle' style={{ width: "100%" }}>
                              <table role="presentation" style={{ backgroundColor: "#AA974B", fontSize: "14px", color: "#FFF", fontFamily: "'Arial', sans-serif" }}>
                                <tr>
                  ...
                  <Row align='right'>
                    <Column align='right'>
                      <Link href="https://prommash-test.ru/">
                        <Img src="https://api.marketing.serconsrus.ru/wp-content/uploads/2024/08/logo-promashtest-ekspertiza.png" alt="telephone" width="180" height="18" />
                      </Link>
                    </Column>
                  </Row>
                  <Row style={{ paddingTop: "70px" }}>
                    <Column align='right' >
                      <Img src="https://api.marketing.serconsrus.ru/wp-content/uploads/2024/08/link-icon-ekspertiza.png" alt="telephone" width="20" height="24" />
                    </Column>
                  </Row>
                  <Row>
                    <Column align='right'>
