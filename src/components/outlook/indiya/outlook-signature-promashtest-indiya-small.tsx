...
import { TemplateOutlookSignaturePromashtestIndiyaSmall } from "../../../templates/templates-outlook-signature/template-outlook-signature-promashtest-indiya-small";

import { ISignatureProps } from "../../../utils/type";

export function OutlookSignaturePromashtestIndiyaSmall({ inputName, inputFamily, inputPatronymic, inputPosition, inputTelephone, inputTelephoneExt, inputTelephoneSecond, inputAddress, avatarUrl }: ISignatureProps) {
